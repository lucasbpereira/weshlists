package com.weshlists.api.security;
...
public class TokenService {
    ...
    private String secret = "3r#$trFVgsdfE$DF%$vbcvb3#FD457dc#$GDSfbvc234";

    public String generateToken(Users userModel){
        try {
        ...
        public String createPasswordResetToken(Users user) {
            try {
                ...
                String token = JWT.create()
                    ...
                    .withExpiresAt(getExpirationDate())  // Expira em 2 horas
                    .sign(algorithm);
                return token;
